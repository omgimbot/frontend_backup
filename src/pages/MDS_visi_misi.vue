    ...
    <div class="col col-lg-12 col-md-6 col-sm-8 col-xs-10 q-pt-md">
      <q-card class="my-card q-pa-md">
        <q-breadcrumbs separator="---" class="text-blue-10" active-color="secondary">
          ...
          <q-breadcrumbs-el label="Visi & Misi" icon="track_changes" />
        </q-breadcrumbs>
      </q-card>
              ...
              <q-card-section class="col q-pa-lg">
                <div class="col row">
                  <div class="col-5 q-table__title">
                    {{this.title}} Visi & Misi Sekolah
                    <p class="text-caption">Posted by Fullname | 01 Januari 2021.</p>
                  </div>
                  <div class="col" align="right">
                    <q-btn color="primary" icon="history_toggle_off" outline label="perbaharui visi & misi" @click="fullWidth = true" />
                  </div>
                </div>
                <q-separator />
                ...
                <div class="q-pa-md" align="center">
                  ...
                  <p class="text-caption text-weight-bold"><q-badge color="primary" class="q-pa-sm">Data visi & misi belum diperbaharui.</q-badge></p>
                </div>
