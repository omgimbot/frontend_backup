    ...
    <div class="col col-lg-12 col-md-6 col-sm-8 col-xs-10 q-pt-md">
      <q-card class="my-card q-pa-md">
        <q-breadcrumbs separator="---" class="text-blue-10" active-color="secondary">
          ...
          <q-breadcrumbs-el label="PPDP" icon="model_training" />
          ...
          <q-card class="my-card col" flat bordered>
            <q-card-section horizontal>
              <q-card-section class="col q-pa-lg">
                <div class="col">
                  <div class="col-2 q-table__title">{{this.title}} Data Peserta Didik Pindahan</div>
                  <p class="text-caption">Form {{this.title}} data peserta didik pindahan.</p>
                </div>
                <q-form @submit="onSubmit" @reset="onReset">
                  ...
                  <div class="row q-gutter-sm">
                    <div class="col">
                      <q-select outlined v-model="form.statusPembelian" dense lazy-rules filled :options="options.status" label="SEKOLAH ASAL" />
                    </div>
                    <div class="col">
                      <q-input
                        filled
                    ...
                    <div class="col">
                      <q-select outlined v-model="form.statusPembelian" dense lazy-rules filled :options="options.status" label="DITERIMA DI KELAS" />
                    </div>
                    <div class="col">
                      <q-select
                        outlined
                    ...
                    >
                      ...
                      >
                        <div class="row q-gutter-sm">
                          ...
                          <div class="col">
                            <q-select outlined v-model="form.statusPembelian" dense lazy-rules filled :options="options.status" label="JENIS KELAMIN" />
                          </div>
                          <div class="col">
                            <q-select outlined v-model="form.statusPembelian" dense lazy-rules filled :options="options.status" label="AGAMA" />
                          </div>
                        </div>
                        ...
                        <div class="row q-gutter-sm">
                          <div class="col">
                            <q-select outlined v-model="form.statusPembelian" dense lazy-rules filled :options="options.status" label="PROVINSI" />
                          </div>
                          <div class="col">
                            <q-select outlined v-model="form.statusPembelian" dense lazy-rules filled :options="options.status" label="KABUPATEN" />
                          </div>
                          <div class="col">
                            <q-select outlined v-model="form.statusPembelian" dense lazy-rules filled :options="options.status" label="KACAMATAN" />
                          </div>
                        </div>

                        <div class="row q-gutter-sm q-mt-md">
                          <div class="col-3">
                            <q-select outlined v-model="form.statusPembelian" dense lazy-rules filled :options="options.status" label="KELURAHAN" />
                          </div>
                          <div class="col">
                            <q-input
                              filled
                        ...
                        <div class="row q-gutter-sm q-mt-sm">
                          <div class="col">
                            <q-select outlined v-model="form.statusPembelian" dense lazy-rules filled :options="options.status" label="ALAT TRANSPORTASI KE SEKOLAH" />
                          </div>
                          <div class="col">
                            <q-select outlined v-model="form.statusPembelian" dense lazy-rules filled :options="options.status" label="JENIS RUMAH TINGGAL" />
                          </div>
                          <div class="col">
                            <q-input
                              filled
                        ...
                        <div class="row q-gutter-sm">
                          <div class="col-3">
                            <q-checkbox indeterminate-value="maybe" v-model="theModel2" label="PENERIMA KPS / PKH" />
                          </div>
                          <div class="col">
                            <q-input
                              filled
                        ...
                        <div class="row q-gutter-sm">
                          <div class="col-3">
                            <q-checkbox indeterminate-value="maybe" v-model="theModel2" label="PENERIMA KIP" />
                          </div>
                          <div class="col">
                            <q-input
                              filled
                      ...
                      >
                        ...
                        <q-stepper-navigation>
                          <q-btn @click="step = 4" color="primary" label="SELANJUTNYA" />
                      ...
                      >
                        ...
                        <q-stepper-navigation>
                          ...
                          <q-btn flat @click="step = 3" color="primary" label="KEMBALI" class="q-ml-sm" />
                        </q-stepper-navigation>
