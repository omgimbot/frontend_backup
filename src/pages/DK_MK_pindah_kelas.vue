    ...
    <div class="col col-lg-12 col-md-6 col-sm-8 col-xs-10 q-pt-md">
      <q-card class="my-card q-pa-md">
        <q-breadcrumbs separator="---" class="text-blue-10" active-color="secondary">
          ...
          <q-breadcrumbs-el label="Pindah Kelas" icon="assignment_return" />
        </q-breadcrumbs>
      </q-card>
          ...
          <q-card class="my-card col" flat bordered>
            <q-card-section horizontal>
              <q-card-section class="col q-pa-lg">
                <div class="col">
                  <div class="col-2 q-table__title">{{this.title}} Data Pindah Kelas</div>
                  <p class="text-caption">Form {{this.title}} data pindah kelas.</p>
                </div>
                <q-form @submit="onSubmit" @reset="onReset">

                  <div class="row q-gutter-sm">
                    <div class="col">
                      <q-select outlined v-model="AS" dense lazy-rules filled :options="options.status" label="KODE KELAS ASAL" />
                    </div>
                    <div class="col">
                      <q-select outlined v-model="AS" dense lazy-rules filled :options="options.status" label="KODE KELAS TUJUAN" />
                    </div>
                  </div>
