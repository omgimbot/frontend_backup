    ...
    <div class="col col-lg-12 col-md-6 col-sm-8 col-xs-10 q-pt-md">
      <q-card class="my-card q-pa-md">
        <q-breadcrumbs separator="---" class="text-blue-10" active-color="secondary">
          ...
          <q-breadcrumbs-el label="Kelas Berjalan" icon="switch_access_shortcut" />
        </q-breadcrumbs>
      </q-card>
            ...
            <q-card-section horizontal>
              <q-card-section class="col q-pa-lg">
                <div class="col">
                  ...
                  <p class="text-caption">Form {{this.title}} data kelas berjalan.</p>
                </div>
                <q-form @submit="onSubmit" @reset="onReset">

                  <div class="row q-gutter-sm">
                    <div class="col">
                      <q-select outlined v-model="AS" dense lazy-rules filled :options="options.status" label="TAHUN AKADEMIK" />
                    </div>
                    <div class="col">
                      <q-select outlined v-model="AS" dense lazy-rules filled :options="options.status" label="RUANG KELAS" />
                    </div>
                  </div>
                  <div class="row q-gutter-sm q-mt-md">
                    <div class="col">
                      <q-select outlined v-model="AS" dense lazy-rules filled :options="options.status" label="KELOMPOK KELAS" />
                    </div>
                  </div>
                  <div class="row q-gutter-sm q-mt-md">
                    <div class="col">
          ...
          <q-card class="my-card col" flat bordered>
            <q-card-section horizontal>
                <q-card-section class="col-12 q-pa-sm">
                  ...
                  <template v-slot:top>
                    <div class="col">
                      <div class="col-2 q-table__title">Master Data Kelompok Kelas / ROMBEL</div>
                      <p class="text-caption">Data kelompok kelas / rombel di sekolah.</p>
                    </div>
...
export default {
  ...
  data () {
    return {
      ...
      totalLunas: 0,
      columns: [
        { name: 'id_pembelian', required: true, label: 'TH. AKADEMIK', align: 'left', field: 'id_pembelian', sortable: true },
        { name: 'supplier', required: true, label: 'WALI', align: 'left', field: 'supplier', sortable: true },
        { name: 'nomorTelepon', required: true, label: 'KELOMPOK', align: 'left', field: 'nomorTelepon', sortable: true },
