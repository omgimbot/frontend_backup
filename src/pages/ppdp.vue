          ...
          <q-card class="my-card col-lg-3 col-md-4 col-sm-7" flat bordered>
            <q-card-section horizontal>
              <q-card-section class="q-pt-xs">
                <div class="text-h6 q-mt-sm" style="font-size: 14px">Data penerimaan peserta didik pindahan</div>
                  <div class="text-caption text-grey" style="font-size:11px">
                    semua data peserta didik pindahan.
                  </div>
                  <div class="row">
          ...
          <q-card class="my-card col" flat bordered>
              <q-card-section horizontal>
                <q-card-section class="col-12 q-pa-sm">
                  ...
                  <template v-slot:top>
                    <div class="col">
                      <div class="col-2 q-table__title">Master Data PPDP</div>
                      <p class="text-caption">Data peserta didik pindahan periode 2020 - 2021.</p>
                    </div>
