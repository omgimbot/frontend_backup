      ...
      <div class="row q-mt-lg">
        ...
        <div class="row q-gutter-md col-12">
          ...
          <q-card class="my-card col-lg-3 col-md-4 col-sm-7" flat bordered>
            <q-card-section horizontal>
              <q-card-section class="q-pt-xs">
                <div class="text-h6 q-mt-sm" style="font-size: 14px">Data pengeluaran</div>
          ...
          <q-card class="my-card col-lg-3 col-md-4 col-sm-7" flat bordered>
            <q-card-section horizontal>
              <q-card-section class="q-pt-xs">
                <div class="text-h6 q-mt-sm" style="font-size: 14px">Pengeluaran habis pakai</div>
                  <div class="text-caption text-grey" style="font-size:11px">
                    berisi semua data pengeluaran habis pakai.
                  </div>
                  <div class="row items-center">
                ...
                <q-card-section class="col-12 q-pa-sm">
                  ...
                  <template v-slot:top>
                    <div class="col">
                      ...
                      <p class="text-caption">Data pengeluaran yang di lakukan di dalam sistem salsafical.</p>
                    </div>
