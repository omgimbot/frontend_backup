              ...
              <q-card-section class="q-pt-xs">
                <div class="text-h6 q-mt-sm" style="font-size: 14px">Barang penjualan retur</div>
                  <div class="text-caption text-grey" style="font-size:11px">
                    berisi semua data retur penjualan salsafical.
                  </div>
            ...
            <q-card-section horizontal>
              <q-card-section class="q-pt-xs">
                <div class="text-h6 q-mt-sm" style="font-size: 14px">Barang pembelian retur</div>
                  <div class="text-caption text-grey" style="font-size:11px">
                    berisi semua data retur pembelian salsafical.
                  </div>
                  <div class="row items-center">
          ...
          <q-card class="my-card col" flat bordered>
              <q-card-section horizontal>
                <q-card-section class="col-12 q-pa-sm">
                  <q-table
                    title="Master Data Barang Retur"
                    aria-label="Text"
                    class="text-h5"
                    :rows="rows"
                    flat
                  ...
                  <template v-slot:top>
                    <div class="col">
                      ...
                      <p class="text-caption">Data retur barang yang di lakukan di dalam sistem salsafical.</p>
                    </div>
