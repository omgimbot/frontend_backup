    ...
    <div class="col col-lg-12 col-md-6 col-sm-8 col-xs-10 q-pt-md">
      <q-card class="my-card q-pa-md">
        <q-breadcrumbs separator="---" class="text-blue-10" active-color="secondary">
          ...
          <q-breadcrumbs-el label="Berkas" icon="fact_check" />
        </q-breadcrumbs>
      </q-card>
          ...
          <q-card class="my-card col" flat bordered>
            <q-card-section horizontal>
              <q-card-section class="col q-pa-lg">
                <div class="col">
                  <div class="col-2 q-table__title">{{this.title}} Data Berkas</div>
                  <p class="text-caption">Form {{this.title}} data berkas.</p>
                </div>
                <q-form @submit="onSubmit" @reset="onReset">
                  ...
                  <div class="row q-gutter-sm">
                    <div class="col">
                      <q-select outlined v-model="form.JENIS" dense lazy-rules filled :options="options.jenis" label="JENIS" />
                    </div>
                    <div class="col">
                      <q-select outlined v-model="form.WAJIB" dense lazy-rules filled :options="options.wajib" label="WAJIB" />
                    </div>
                  </div>
                  <div class="q-mt-md">
          ...
          <q-card class="my-card col" flat bordered>
            <q-card-section horizontal>
                <q-card-section class="col-12 q-pa-sm">
                  ...
                  <template v-slot:top>
                    <div class="col">
                      <div class="col-2 q-table__title">Master Data Berkas</div>
                      <p class="text-caption">Data berkas sekolah.</p>
                    </div>
  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'supplier', required: true, label: 'JENIS PENGGUNAAN', align: 'left', field: 'supplier', sortable: true },
        { name: 'nomorTelepon', required: true, label: 'STATUS', align: 'left', field: 'nomorTelepon', sortable: true },
