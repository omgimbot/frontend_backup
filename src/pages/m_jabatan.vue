    ...
    <div class="col col-lg-12 col-md-6 col-sm-8 col-xs-10 q-pt-md">
      <q-card class="my-card q-pa-md">
        <q-breadcrumbs separator="---" class="text-blue-10" active-color="secondary">
          ...
          <q-breadcrumbs-el label="Jabatan" icon="insights" />
        </q-breadcrumbs>
      </q-card>
          ...
          <q-card class="my-card col" flat bordered>
            <q-card-section horizontal>
              <q-card-section class="col q-pa-lg">
                <div class="col">
                  <div class="col-2 q-table__title">{{this.title}} Data Jabatan</div>
                  <p class="text-caption">Form {{this.title}} data jabatan.</p>
                </div>
                <q-form @submit="onSubmit" @reset="onReset">
                  ...
                  <div class="row q-gutter-sm">
                    ...
                    <div class="col">
                      <q-select outlined v-model="form.LEVEL" dense lazy-rules filled :options="options.status" label="LEVEL" />
                    </div>
                  </div>
                  <div class="row q-gutter-sm">
                    <div class="col">
          ...
          <q-card class="my-card col" flat bordered>
            <q-card-section horizontal>
                <q-card-section class="col-12 q-pa-sm">
                  ...
                  <template v-slot:top>
                    <div class="col">
                      <div class="col-2 q-table__title">Master Data Jabatan</div>
                      <p class="text-caption">Data jabatan di sekolah.</p>
                    </div>
...
export default {
  ...
  data () {
    return {
      ...
      totalLunas: 0,
      columns: [
        { name: 'id_pembelian', required: true, label: 'JABATAN', align: 'left', field: 'id_pembelian', sortable: true },
        { name: 'supplier', required: true, label: 'LEVEL', align: 'left', field: 'supplier', sortable: true },
      ...
      options: {
        status: [
          'Administrator', '(0001) Guru Absensn', '(0002) Wali Kelas', '(0003) Kesiswaan', '(0004) Kurikulum', '(0005) Penjamin Mutu'
        ]
      }
    }
  },
