      ...
      <div class="row q-mt-lg">
        ...
        <div class="row q-gutter-md col-12">
          <q-card class="my-card col-lg-2 col-md-4 col-sm-7" flat bordered>
            <q-card-section horizontal>
              <q-card-section class="q-pt-xs">
                <div class="text-h6 q-mt-sm" style="font-size: 14px">Modal dari luar</div>
                  <div class="text-caption text-grey" style="font-size:11px">
                    semua modal yang di dapatkan dari luar.
                  </div>
          ...
          <q-card class="my-card col-lg-2 col-md-4 col-sm-7" flat bordered>
            <q-card-section horizontal>
              <q-card-section class="q-pt-xs">
                <div class="text-h6 q-mt-sm" style="font-size: 14px">Modal mandiri</div>
                  <div class="text-caption text-grey" style="font-size:11px">
                    semua modal milik sendiri.
                  </div>
                  <div class="row items-center">
                ...
                <q-card-section class="col-12 q-pa-sm">
                  ...
                  <template v-slot:top>
                    <div class="col">
                      ...
                      <p class="text-caption">Data moda yang di miliki salsafical.</p>
                    </div>
