    ...
    <div class="col col-lg-12 col-md-6 col-sm-8 col-xs-10 q-pt-md">
      <q-card class="my-card q-pa-md">
        <q-breadcrumbs separator="---" class="text-blue-10" active-color="secondary">
          ...
          <q-breadcrumbs-el label="Kelompok Kelas / ROMBEL" icon="supervised_user_circle" />
        </q-breadcrumbs>
      </q-card>
          ...
          <q-card class="my-card col" flat bordered>
            <q-card-section horizontal>
              <q-card-section class="col q-pa-lg">
                <div class="col">
                  <div class="col-2 q-table__title">{{this.title}} Data Kelompok Kelas / ROMBEL</div>
                  <p class="text-caption">Form {{this.title}} data kelompok kelas / rombel.</p>
                </div>
                <q-form @submit="onSubmit" @reset="onReset">
                  ...
                  <div class="row q-gutter-sm">
                    <div class="col">
                      <q-select outlined v-model="AS" dense lazy-rules filled :options="options.status" label="PROGRAM KEAHLIAN" />
                    </div>
                    <div class="col">
                      <q-select outlined v-model="AS" dense lazy-rules filled :options="options.status" label="TINGKAT KELAS" />
                    </div>
                  </div>
...
export default {
  ...
  data () {
    return {
      ...
      totalLunas: 0,
      columns: [
        { name: 'id_pembelian', required: true, label: 'KODE', align: 'left', field: 'id_pembelian', sortable: true },
        { name: 'supplier', required: true, label: 'NAMA', align: 'left', field: 'supplier', sortable: true },
        { name: 'nomorTelepon', required: true, label: 'TINGKAT', align: 'left', field: 'nomorTelepon', sortable: true },
