    ...
    <div class="col col-lg-12 col-md-6 col-sm-8 col-xs-10 q-pt-md">
      <q-card class="my-card q-pa-md">
        <q-breadcrumbs separator="---" class="text-blue-10" active-color="secondary">
          ...
          <q-breadcrumbs-el label="Daftar Siswa Diterima" icon="history_edu" />
        </q-breadcrumbs>
      </q-card>
          ...
          <q-card class="my-card col-lg-3 col-md-4 col-sm-7" flat bordered>
            <q-card-section horizontal>
              <q-card-section class="q-pt-xs">
                <div class="text-h6 q-mt-sm" style="font-size: 14px">Data peserta didik diterima</div>
                  <div class="text-caption text-grey" style="font-size:11px">
                    semua data peserta didik diterima.
                  </div>
                  <div class="row">
          ...
          <q-card class="my-card col" flat bordered>
              <q-card-section horizontal>
                <q-card-section class="col-12 q-pa-sm">
                  ...
                  <template v-slot:top>
                    <div class="col">
                      <div class="col-2 q-table__title">Master Data Daftar Siswa Diterima</div>
                      <p class="text-caption">Data peserta didik diterima.</p>
                    </div>
...
export default {
  ...
  data () {
    return {
      ...
      totalLunas: 0,
      columns: [
        { name: 'id_pembelian', required: true, label: 'TIPE', align: 'left', field: 'id_pembelian', sortable: true },
        { name: 'supplier', required: true, label: 'NISN', align: 'left', field: 'supplier', sortable: true },
        { name: 'nomorTelepon', required: true, label: 'NAMA SISWA', align: 'left', field: 'nomorTelepon', sortable: true },
        { name: 'statusPembelian', required: true, label: 'JURUSAN', align: 'left', field: 'statusPembelian', sortable: true },
