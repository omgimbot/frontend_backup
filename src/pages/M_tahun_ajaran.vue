    ...
    <div class="col col-lg-12 col-md-6 col-sm-8 col-xs-10 q-pt-md">
      <q-card class="my-card q-pa-md">
        <q-breadcrumbs separator="---" class="text-blue-10" active-color="secondary">
          ...
          <q-breadcrumbs-el label="Tahun Ajaran" icon="today" />
        </q-breadcrumbs>
      </q-card>
          ...
          <q-card class="my-card col" flat bordered>
            <q-card-section horizontal>
              <q-card-section class="col q-pa-lg">
                <div class="col">
                  <div class="col-2 q-table__title">{{this.title}} Data Tahun Ajaran</div>
                  <p class="text-caption">Form {{this.title}} data tahun ajaran.</p>
                </div>
                <q-form @submit="onSubmit" @reset="onReset">
                  ...
                  <div class="row q-gutter-sm q-mt-xs">
                    <div class="col">
                      <q-select outlined v-model="form.SEMESTER" dense lazy-rules filled :options="options.semester" label="SEMESTER" />
                    </div>
                    <div class="col">
                      <q-select outlined v-model="form.STATUS" dense lazy-rules filled :options="options.status" label="STATUS" />
                    </div>
                  </div>
          ...
          <q-card class="my-card col" flat bordered>
            <q-card-section horizontal>
                <q-card-section class="col-12 q-pa-sm">
                  ...
                  <template v-slot:top>
                    <div class="col">
                      <div class="col-2 q-table__title">Master Data Tahun Ajaran</div>
                      <p class="text-caption">Data tahun ajaran di sekolah.</p>
                    </div>
  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'supplier', required: true, label: 'SEMESTER', align: 'left', field: 'supplier', sortable: true },
