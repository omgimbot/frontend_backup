    ...
    <div class="col col-lg-12 col-md-6 col-sm-8 col-xs-10 q-pt-md">
      <q-card class="my-card q-pa-md">
        <q-breadcrumbs separator="---" class="text-blue-10" active-color="secondary">
          ...
          <q-breadcrumbs-el label="Ekstra Kurikuler" icon="connect_without_contact" />
        </q-breadcrumbs>
      </q-card>
          ...
          <q-card class="my-card col" flat bordered>
            <q-card-section horizontal>
              <q-card-section class="col q-pa-lg">
                <div class="col">
                  <div class="col-2 q-table__title">{{this.title}} Data Ekstra Kurikuler</div>
                  <p class="text-caption">Form {{this.title}} data ekstra kurikuler.</p>
                </div>
                <q-form @submit="onSubmit" @reset="onReset">
                  ...
                  <div class="row q-gutter-sm">
                    <div class="col">
                      <q-select outlined v-model="form.PEMBINA" dense lazy-rules filled :options="options.status" label="PEMBINA" />
                    </div>
                  </div>
                  <div class="q-mt-md">
          ...
          <q-card class="my-card col" flat bordered>
            <q-card-section horizontal>
                <q-card-section class="col-12 q-pa-sm">
                  <q-table
                    title="Master Data Ekstra Kurikuler"
                    aria-label="Text"
                    class="text-h5"
                    :rows="rows"
                    flat
                  ...
                  <template v-slot:top>
                    <div class="col">
                      <div class="col-2 q-table__title">Master Data Ekstra Kurikuler</div>
                      <p class="text-caption">Data ekstra kurikuler sekolah.</p>
                    </div>
...
export default {
  ...
  data () {
    return {
      ...
      totalLunas: 0,
      columns: [
        { name: 'id_pembelian', required: true, label: 'EKSKUL', align: 'left', field: 'id_pembelian', sortable: true },
        { name: 'supplier', required: true, label: 'PEMBINA', align: 'left', field: 'supplier', sortable: true },
