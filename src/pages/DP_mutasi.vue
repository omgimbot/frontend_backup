    ...
    <div class="col col-lg-12 col-md-6 col-sm-8 col-xs-10 q-pt-md">
      <q-card class="my-card q-pa-md">
        <q-breadcrumbs separator="---" class="text-blue-10" active-color="secondary">
          ...
          <q-breadcrumbs-el label="Mutasi Pegawai" icon="compare_arrows" />
        </q-breadcrumbs>
      </q-card>
          ...
          <q-card class="my-card col" flat bordered>
            <q-card-section horizontal>
              <q-card-section class="col q-pa-lg">
                <div class="col">
                  <div class="col-2 q-table__title">{{this.title}} Data Mutasi Pegawai</div>
                  <p class="text-caption">Form {{this.title}} data mutasi pegawai.</p>
                </div>
                <q-form @submit="onSubmit" @reset="onReset">
                  ...
                  <div class="row q-gutter-sm q-mt-md">
                    <div class="col">
                      <q-input filled v-model="form" dense label="TANGGAL MUTASI">
          ...
          <q-card class="my-card col" flat bordered>
            <q-card-section horizontal>
                <q-card-section class="col-12 q-pa-sm">
                  ...
                  <template v-slot:top>
                    <div class="col">
                      <div class="col-2 q-table__title">Master Data Mutasi Pegawai</div>
                      <p class="text-caption">Data mutasi pegawai di sekolah.</p>
                    </div>
  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'supplier', required: true, label: 'TANGGAL', align: 'left', field: 'supplier', sortable: true },
        { name: 'nomorTelepon', required: true, label: 'ALASAN', align: 'left', field: 'nomorTelepon', sortable: true },
