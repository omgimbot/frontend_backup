    ...
    <div class="col col-lg-12 col-md-6 col-sm-8 col-xs-10 q-pt-md">
      <q-card class="my-card q-pa-md">
        <q-breadcrumbs separator="---" class="text-blue-10" active-color="secondary">
          ...
          <q-breadcrumbs-el label="Biaya Sekolah" icon="request_quote" />
        </q-breadcrumbs>
      </q-card>
          ...
          <q-card class="my-card col" flat bordered>
            <q-card-section horizontal>
              <q-card-section class="col q-pa-lg">
                <div class="col">
                  <div class="col-2 q-table__title">{{this.title}} Data Biaya Sekolah</div>
                  <p class="text-caption">Form {{this.title}} data biaya sekolah.</p>
                </div>
                  ...
                  <div class="row q-gutter-sm">
                    <div class="col">
                      ...
                      <template v-slot:prepend>
                        <div class="text-subtitle1">Rp.</div>
                      </template>
                      </q-input>
                    </div>
                  </div>
          ...
          <q-card class="my-card col" flat bordered>
            <q-card-section horizontal>
                <q-card-section class="col-12 q-pa-sm">
                  ...
                  <template v-slot:top>
                    <div class="col">
                      <div class="col-2 q-table__title">Master Data Biaya Sekolah</div>
                      <p class="text-caption">Data biaya di sekolah.</p>
                    </div>
...
export default {
  ...
  data () {
    return {
      ...
      totalLunas: 0,
      columns: [
        { name: 'id_pembelian', required: true, label: 'BIAYA', align: 'left', field: 'id_pembelian', sortable: true },
        { name: 'supplier', required: true, label: 'BESARAN', align: 'left', field: 'supplier', sortable: true },
