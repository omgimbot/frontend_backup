    ...
    <div class="col col-lg-12 col-md-6 col-sm-8 col-xs-10 q-pt-md">
      <q-card class="my-card q-pa-md">
        <q-breadcrumbs separator="---" class="text-blue-10" active-color="secondary">
          ...
          <q-breadcrumbs-el label="Berkas Pegawai" icon="contact_page" />
        </q-breadcrumbs>
      </q-card>
          ...
          <q-card class="my-card col" flat bordered>
            <q-card-section horizontal>
              <q-card-section class="col q-pa-lg">
                <div class="col">
                  <div class="col-2 q-table__title">{{this.title}} Data Berkas Pegawai</div>
                  <p class="text-caption">Form {{this.title}} data berkas pegawai.</p>
                </div>
                <q-form @submit="onSubmit" @reset="onReset">
                  ...
                  <div class="row q-gutter-sm q-mt-md">
                    <div class="col">
                      <q-select outlined v-model="AS" dense lazy-rules filled :options="options.status" label="JENIS BERKAS" />
                    </div>
                    <div class="col">
                      <q-file clearable color="orange" filled lazy-rules dense bottom-slots v-model="model" label="PILIH BERKAS" counter>
                  ...
                  <div class="q-mt-md">
                    <q-btn label="Perbaharui" outline type="submit" color="green" style="width:150px" />
          ...
          <q-card class="my-card col" flat bordered>
            <q-card-section horizontal>
                <q-card-section class="col-12 q-pa-sm">
                  ...
                  <template v-slot:top>
                    <div class="col">
                      <div class="col-2 q-table__title">Master Data Berkas Pegawai</div>
                      <p class="text-caption">Data berkas pegawai di sekolah.</p>
                    </div>
...
export default {
  ...
  data () {
    return {
      ...
      model: null,
      columns: [
        { name: 'id_pembelian', required: true, label: 'NAMA PEGAWAI', align: 'left', field: 'id_pembelian', sortable: true },
        { name: 'supplier', required: true, label: 'FILE BERKAS', align: 'left', field: 'supplier', sortable: true },
