    ...
    <div class="col col-lg-12 col-md-6 col-sm-8 col-xs-10 q-pt-md">
      <q-card class="my-card q-pa-md">
        <q-breadcrumbs separator="---" class="text-blue-10" active-color="secondary">
          ...
          <q-breadcrumbs-el label="Kelengkapan Pegawai" icon="auto_awesome_motion" />
        </q-breadcrumbs>
      </q-card>
          ...
          <q-card class="my-card col" flat bordered>
            <q-card-section horizontal>
              <q-card-section class="col q-pa-lg">
                <div class="col">
                  <div class="col-2 q-table__title">{{this.title}} Data Kelengkapan Pegawai</div>
                  <p class="text-caption">Form {{this.title}} data kelengkapan pegawai.</p>
                </div>
                <q-form @submit="onSubmit" @reset="onReset">
                  ...
                  <div class="row q-gutter-sm q-mt-md">
                    <div class="col">
                      <q-select outlined v-model="AS" dense lazy-rules filled :options="options.kelengkapan" label="JENIS KELENGKAPAN" />
                    </div>
                    <div class="col">
                      <q-input
                        filled
          ...
          <q-card class="my-card col" flat bordered>
            <q-card-section horizontal>
                <q-card-section class="col-12 q-pa-sm">
                  ...
                  <template v-slot:top>
                    <div class="col">
                      <div class="col-2 q-table__title">Master Data Kelengkapan Pegawai</div>
                      <p class="text-caption">Data kelengkapan pegawai di sekolah.</p>
                    </div>
