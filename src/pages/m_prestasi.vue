    ...
    <div class="col col-lg-12 col-md-6 col-sm-8 col-xs-10 q-pt-md">
      <q-card class="my-card q-pa-md">
        <q-breadcrumbs separator="---" class="text-blue-10" active-color="secondary">
          ...
          <q-breadcrumbs-el label="Prestasi" icon="emoji_events" />
        </q-breadcrumbs>
      </q-card>
          ...
          <q-card class="my-card col" flat bordered>
            <q-card-section horizontal>
              <q-card-section class="col q-pa-lg">
                <div class="col">
                  <div class="col-2 q-table__title">{{this.title}} Data Prestasi</div>
                  <p class="text-caption">Form {{this.title}} data prestasi.</p>
                </div>
          ...
          <q-card class="my-card col" flat bordered>
            <q-card-section horizontal>
                <q-card-section class="col-12 q-pa-sm">
                  ...
                  <template v-slot:top>
                    <div class="col">
                      <div class="col-2 q-table__title">Master Data Prestasi</div>
                      <p class="text-caption">Data prestasi di sekolah.</p>
                    </div>
  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'supplier', required: true, label: 'PRESTASI', align: 'left', field: 'supplier', sortable: true },
